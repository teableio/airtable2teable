import { IdPrefix, StatisticsFunc, TeableViewTypeEnum, TIME_ZONE_LIST, } from '@/types';
import { z } from 'zod';
import { dataFieldCellValueSchema } from '../fields';
import { formViewOptionSchema, gridViewOptionSchema, kanbanViewOptionSchema, } from './derivate';
import { conjunctionSchema, operators, subOperators, symbols, } from './operator.schema';
...
export const nestedFilterItemSchema = baseFilterSetSchema.extend({
    filterSet: z.lazy(() => z.array(z.union([filterItemSchema, nestedFilterItemSchema]))),
});
...
export const gridColumnSchema = columnSchemaBase.merge(z.object({
    width: z.number().optional(),
    hidden: z.boolean().optional(),
    statisticFunc: z.nativeEnum(StatisticsFunc).nullable().optional(),
}));
export const kanbanColumnSchema = columnSchemaBase.merge(z.object({
    hidden: z.boolean().optional(),
}));
export const formColumnSchema = columnSchemaBase.merge(z.object({
